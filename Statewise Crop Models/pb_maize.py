...
Original file is located at
    https://colab.research.google.com/drive/1VlSF5zwfblc1mTvpuwtnCkKOKfDuXf9L
"""
...
path = r"C:\Users\anush\OneDrive\Desktop\SIH-Project-Central-Crew\Utils\Final processed csv files\Punjab_Maize.csv"
df = pd.read_csv(path)
...
june.fit(X, Y)
pickle.dump(june, open('PB_Maize/june.pkl', 'wb'))
...
july.fit(X,Y)
pickle.dump(july, open('PB_Maize/july.pkl', 'wb'))
...
august.fit(X, Y)
pickle.dump(august, open('PB_Maize/august.pkl', 'wb'))
...
september.fit(X, Y)
pickle.dump(september, open('PB_Maize/september.pkl', 'wb'))
...
october.fit(X, Y)
pickle.dump(october, open('PB_Maize/october.pkl', 'wb'))
...
november.fit(X, Y)
pickle.dump(november, open('PB_Maize/november.pkl', 'wb'))
