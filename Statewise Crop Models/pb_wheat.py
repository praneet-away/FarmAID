...
Original file is located at
    https://colab.research.google.com/drive/1wT3H-XY9MTc1FCaOvPni4h7IQQND0HUe
"""
...
path = r"C:\Users\anush\OneDrive\Desktop\SIH-Project-Central-Crew\Utils\Final processed csv files\Punjab_Wheat.csv"
df = pd.read_csv(path)
...
november.fit(X,Y)
pickle.dump(november, open('PB_Wheat/november.pkl', 'wb'))
...
december.fit(X, Y)
pickle.dump(december, open('PB_Wheat/december.pkl', 'wb'))
...
january.fit(X, Y)
pickle.dump(january, open('PB_Wheat/january.pkl', 'wb'))
...
february.fit(X, Y)
pickle.dump(february, open('PB_Wheat/february.pkl', 'wb'))
