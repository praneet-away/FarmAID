...
path = r"C:\Users\anush\OneDrive\Desktop\SIH-Project-Central-Crew\Utils\Final processed csv files\UP_Rice.csv"
df = pd.read_csv(path)
...
june.fit(X, Y)
pickle.dump(june, open('UP_Rice/june.pkl', 'wb'))
...
july.fit(X,Y)
pickle.dump(july, open('UP_Rice/july.pkl', 'wb'))
...
august.fit(X, Y)
pickle.dump(august, open('UP_Rice/august.pkl', 'wb'))
...
september.fit(X, Y)
pickle.dump(september, open('UP_Rice/september.pkl', 'wb'))
...
october.fit(X, Y)
pickle.dump(october, open('UP_Rice/october.pkl', 'wb'))
...
november.fit(X, Y)
pickle.dump(november, open('UP_Rice/november.pkl', 'wb'))
