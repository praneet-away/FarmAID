...
Original file is located at
    https://colab.research.google.com/drive/1K1MSk6Ks9Lk8t37EHx-JD7wHDjdoPxJu
"""
...
path = r"C:\Users\anush\OneDrive\Desktop\SIH-Project-Central-Crew\Utils\Final processed csv files\Haryana_Wheat.csv"
df = pd.read_csv(path)
...
october.fit(X, Y)
pickle.dump(october, open('HR_Wheat/october.pkl', 'wb'))
...
november.fit(X,Y)
pickle.dump(november, open('HR_Wheat/november.pkl', 'wb'))
...
december.fit(X, Y)
pickle.dump(december, open('HR_Wheat/december.pkl', 'wb'))
...
january.fit(X, Y)
pickle.dump(january, open('HR_Wheat/january.pkl', 'wb'))
...
february.fit(X, Y)
pickle.dump(february, open('HR_Wheat/february.pkl', 'wb'))
