...
Original file is located at
    https://colab.research.google.com/drive/14HBSrhxiJiISYcKB34ZV7NOtyUMzLA_g
"""
...
path = r"C:\Users\anush\OneDrive\Desktop\SIH-Project-Central-Crew\Utils\Final processed csv files\Punjab_Rice.csv"
df = pd.read_csv(path)
...
june.fit(X, Y)
pickle.dump(june, open('PB_Rice/june.pkl', 'wb'))
...
july.fit(X,Y)
pickle.dump(july, open('PB_Rice/july.pkl', 'wb'))
...
august.fit(X, Y)
pickle.dump(august, open('PB_Rice/august.pkl', 'wb'))
...
september.fit(X, Y)
pickle.dump(september, open('PB_Rice/september.pkl', 'wb'))
...
october.fit(X, Y)
pickle.dump(october, open('PB_Rice/october.pkl', 'wb'))
...
november.fit(X, Y)
pickle.dump(november, open('PB_Rice/november.pkl', 'wb'))
